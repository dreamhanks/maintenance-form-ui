  ...
  return (
    <section className={sectionWrap}>
      ...
      <div className="grid grid-cols-12">
        ...
        <ValueCell className="col-span-4">
            <textarea value={props.designRemark} onChange={(e) => props.setDesignRemark(e.target.value)} rows={3} maxLength={100} placeholder="備考" className="w-full rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm outline-none focus:border-[#17375E] focus:ring-2 focus:ring-[#17375E]/20" />
        </ValueCell>
      </div>
    </section>
  );
